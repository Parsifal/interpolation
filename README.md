...
<div align="center">
  <br /><br /><img src="https://upload.wikimedia.org/wikipedia/commons/5/59/Splined_epitrochoid.svg" /> <br /><br />
  <p>
...
Interpolation is available under the [GNU General Public License v3.0](LICENSE). Interpolation also includes external libraries that are available under a variety of licenses. See [LICENSE](LICENSE) for the full license text.
